    ...
    return {
      ...
      title_and_alt: (() => {
        return {
          ...
          total_both: document.querySelectorAll('*[title][alt]').length,
        };
      })(),
      no_destination_anchors: (() => {
      ...
      total_tables_with_role_presentational: (() => {
      ...
      divs_or_spans_as_button_or_link: (() => {
        ...
        const total_role_link = document.querySelectorAll('div[role="link" i], span[role="link" i]');
